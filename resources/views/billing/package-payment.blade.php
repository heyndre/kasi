        ...
        <div class="">
            <div class="text-2xl font-bold drop-shadow-md">
                {{-- <span class="drop-shadow-md"> --}}
                    Nota Penggunaan SIPAKA - {{str_pad($billing->invoice_id, 5, '0', STR_PAD_LEFT)}}
                    {{-- </span> --}}
            </div>
            <div class="text-sm font-thin mt-2">Nota dibuat pada {{now()->format('d/m/Y H:i:s T')}}</div>
        </div>
    </div>
