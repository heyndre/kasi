                        ...
                        <div class="ms-3 relative">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link target='_blank' href="https://wa.me/{{$setting->where('key','whatsapp')->value('value')}}?text=Halo%2C saya butuh bantuan tentang Portal KASI bagian Billing/Tagihan dan Pembayaran">
                                        Hubungi Admin KASI
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
                        ...
                        <div class="ms-3 relative">
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link target='_blank' href="https://wa.me/{{$setting->where('key','whatsapp')->value('value')}}?text=Halo%2C saya butuh bantuan tentang Portal KASI bagian Kelas">
                                        Hubungi Admin KASI
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
