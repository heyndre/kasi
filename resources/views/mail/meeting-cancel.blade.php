                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        ...
                                                                        @endif
                                                                        <br>
                                                                        Berikut informasi pembatalan kelas KASI
                                                                        <br>
                                                                        Kelas : {{$data['className']}}
                                                                        #{{$data['classID']}} | {{$data['classDate']}}
                                                                        <br>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;">Email ini
                                                                    merupakan email untuk anggota KASI. Jika kamu merasa
                                                                    bukan anggota KASI, silakan hubungi <a rel="noopener"
