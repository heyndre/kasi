                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        ...
                                                                        datang di Portal KASI. Anda dapat membuka Portal
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;">
                                                                    <span
                                                                        ...
                                                                        Email / Username login : {{$data['guardianEmail']}} atau {{$data['guardianMobile']}}
                                                                    </span>
                                                                </p>
                                                                <p style="font-size: 14px; line-height: 170%;">
                                                                    <span
                                                                        style="font-size: 14px; line-height: 23.8px; font-family: helvetica, sans-serif;">
                                                                        Password login : {{$data['guardianPassword']}}
                                                                        <br>
                                                                        Mohon untuk memperhatikan penggunaan huruf besar/kecil jika tersedia.
                                                                    </span>
                                                                </p>
                                                            </div>
                                                        </td>
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://instagram.com/kangenmenginspirasi"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                                        <img src="{{$message->embed(storage_path('app/emails/image-1.png'))}}"
                                                                                            alt="Instagram"
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.linkedin.com/company/kangenmenginspirasi/about/"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="{{$message->embed(storage_path('app/emails/image-2.png'))}}"
                                                                                            alt="LinkedIn"
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://wa.me/625179824064"
                                                                                        title="WhatsApp"
                                                                                        target="_blank">
                                                                                        <img src="{{$message->embed(storage_path('app/emails/image-3.png'))}}"
                                                                                            alt="WhatsApp"
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-text-align"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 170%;">Bersama
                                                                    KASI,</p>
                                                                <p style="font-size: 14px; line-height: 170%;">Belajar
                                                                    Dulu, Menginspirasi Kemudian!</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
