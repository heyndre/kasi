        ...
        <div class="px-4 py-2">
            <form wire:submit.prevent='uploadPayment' class="grid grid-cols-2 gap-4">
                <div class="mt-6">
                    ...
                    Nomor Pembayaran Tutor : {{str_pad($data[0]->payment_number, 5, '0', STR_PAD_LEFT)}}
                    <p>Jumlah ditagihkan : Rp.{{number_format($total, 2, ',', '.')}}</p>
                    <p class="italic">Terbilang : {{Terbilang::make($total, ' rupiah')}}</p>
                </div>
                <div class="mb-6">
