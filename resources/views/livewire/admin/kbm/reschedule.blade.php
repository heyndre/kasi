        ...
        <div class="px-4 py-2">
            <div class="w-full">
                ...
                <div class="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-green-800 dark:text-green-400"
                    ...
                    <div>
                        <span class="font-medium">INFO | </span> Jadwal tersedia
                    </div>
                </div>
                @endif
                ...
                <div class="flex items-center p-4 mb-4 text-sm text-orange-800 rounded-lg bg-orange-50 dark:bg-orange-800 dark:text-orange-400"
                    ...
                    <div>
                        <span class="font-medium">Peringatan | </span> Pilih tanggal kelas baru serta isi durasi kemudian pilih Cek Ketersediaan
                    </div>
                </div>
                @endif
            </div>
            ...
            <form wire:submit.prevent='scheduleClass' class="grid grid-cols-2 gap-4">
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-y-4">
                        ...
                        <div class="">
                            {{$course->theStudent->nim}} - {{$course->theStudent->userData->nickname}}
                        </div>
                        <div class="font-semibold">
                            Jadwal Pelaksanaan : 
                        </div>
                        <div class="">
                            {{$course->date_of_event->format('d/m/Y H:i T')}} hingga {{$course->date_of_event->addMinutes($course->length)->format('d/m/Y H:i T')}}
                            <p class="font-thin">{{$course->length}} menit</p>
                        </div>
                    </div>
                </div>
                <div class=""></div>
                ...
                <div class="block col-span-2">
                    <button type="submit"
                        class="{{$availability == 'available' ? '' : 'hidden'}} text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
