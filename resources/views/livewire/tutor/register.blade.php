            ...
            <form wire:submit.prevent='register' class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-6">
                    <label for="nickname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Nickname/Username Tutor
                        @error('nickname')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>
                            {{$message}}</p>
                        @enderror
                    </label>
                    <input type="tel" id="nickname" name="nickname" wire:model.live.debounce='nickname'
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                        placeholder="Masukkan nickname/username tutor untuk login">
                </div>
                {{-- Name --}}
                <div class="mb-6">
                ...
                <div class="mb-6 col-span-2" wire:ignore>
                    <label for="skills" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        Mata Pelajaran/Bidang yang dapat diajar oleh Tutor
                        @error('skills')
                        <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Oops!</span>
                            {{$message}}</p>
                        @enderror
                        <p class="text-sm text-gray-700 text-regular">
                            Dapat memilih lebih dari satu
                        </p>
                    </label>
                    <select name="skills" id="skills" wire:model.live='skills' class="w-full" multiple>
                        @foreach ($skillBase as $item)
                ...
                <div class="row-span-2">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="bank_account" name="bankAccount" wire:model.live.debounce='bankAccount'
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                ...
                <div class="block col-span-2">
                    ...
                    <div class="flex " wire:loading.remove wire:target="register">
                        <button type="submit" 
