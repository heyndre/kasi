<li {{ $attributes->merge(['class' => 'mb-10 ms-6']) }}>
    <span
        ...
        <svg class="w-2.5 h-2.5 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    <a href="{{$link}}" {{isset($target) ? 'target="' .$target.'"' : '' }}
        class="mb-2 inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
        <svg class="w-3.5 h-3.5 me-2.5 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
    ...
    @if ($link2 != null && $link2 != '')
    <a href="{{$link2}}" {{isset($target2) ? 'target="' .$target2.'"' : '' }}
